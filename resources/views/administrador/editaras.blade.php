...
@section('ruta','Editar Asesor')
@section('contenido')
<div id="ft" class="row">
    <div class="col-sm-12">
        <fieldset class="col-md-12">
            <form action="{{ route('administrador.editaras.guardar',  [$admin->id , $alumno->id]) }}" method="get">
                <br><br>
                <div class="row">
                    <div class="col-md-4 ">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label style="color:#000000" class="control-label" for="nombre"><i
                                    style="color:#000000; margin-right:2px" class="fas fa-address-card">
                                </i> Materas a Impartir</label>
                            <div>
                                <input value="{{ $alumno->mat }}" style="color:#000000" type="tex" id="mat" name="mat"
                                    placeholder="Materias" class="form-control input-md" required>
                            </div>
                        </div><br>
                    </div>
                </div>
