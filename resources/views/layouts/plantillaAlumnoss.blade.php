...
<body class="dark-edition">
    ...
    -->
            <div id="lg" class="logo">
                <a href="{{ route('alumnos.perfil', Crypt::encrypt($alu->no_cont) )}}" class="simple-text logo-normal">
            ...
            <div id="wp" class="sidebar-wrapper">
                <ul class="nav">
                    <li class="nav-item ">
                        <a href="{{route('alumnos.asesores', Crypt::encrypt($alu->id))}}" class="nav-link">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" target="_blank"
                            href="https://elibro.net/es/lc/biblioitsch/login_usuario/?next=/es/lc/biblioitsch/inicio/">
                                        ...
                                        <div>
                                            ...
                                            <ul class="dropdown-menu extended logout">
                                                <li class="eborder-top">
                                                    <a
                                                        href="{{ route('alumnos.perfil', Crypt::encrypt($alu->no_cont) )}}">
                                                        Mi
                                                        Perfil</a>
                                                </li>
                                                <li>
                                                    <a href="{{route('alumnos_log')}}"> Cerrar Sesión</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
