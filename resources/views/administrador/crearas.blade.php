...
@section('ruta','Crear Asesor')
@section('contenido')
<div id="ft" class="row">
  <div class="col-sm-12">
    <fieldset class="col-md-12">
      <form action="{{ route('administrador.guardaras',  $admin->id) }}" method="get"><br><br>
        <div class="row">
          <div class="col-md-4 ">
        ...
        <div class="row">
          ...
          <div class="col-md-3 ">
            <div class="form-group">
              <label class="control-label" for="tel"><i style=" margin-right:4px" class="fas fa-mobile-alt"></i>Número
                de teléfono</label>
              <div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label style="color:#000000" class="control-label" for="nombre"><i style="color:#000000; margin-right:2px"
                  class="fas fa-address-card">
                </i> Materas a Impartir</label>
              <div>
                <input style="color:#000000" type="tex" id="mat" name="mat" placeholder="Materias"
                  class="form-control input-md" required>
              </div>
            </div><br>
          </div>
        ...
        <div class="panel-footer center">
          <a data-toggle="tooltip" type="button" class="btn btn-danger"
            href="{{route('administrador.asesores', $admin->id)}}">Cancelar</a>
