...
@section('ruta','Registrar Asesoria')
@section('contenido')
<div id="ft" class="row">
    <div class="col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="tex" id="materia" name="materia" placeholder="Materia"
                                    class="form-control input-md" required>
                            </div>
                        </div><br>
                    </div>
                    <div class="col-md-4 ">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="tex" id="tema" name="tema" placeholder="Tema" class="form-control input-md"
                                    required>
                            </div>
                        </div><br>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-7 ">
                        <div class="form-group">
                            ...
                            <div>
                                <input type="tex" id="nombre" name="nombre" placeholder="Nombre Completo"
                                    class="form-control input-md" required>
                            </div>
                        </div><br>
                    </div>
