...
<body class="dark-edition">
    ...
    -->
            <div id="lg" class="logo">
                <a href="{{ route('administrador.perfil', Crypt::encrypt($admin->matricula) )}}"
            ...
            <div id="wp" class="sidebar-wrapper">
                <ul class="nav">
                    <li class="nav-item ">
                        <a class="nav-link" href="{{route('administrador.asesores', $admin->id)}}">
                            <i class="fas fas fa-user-alt" style='font-size:18px'></i>
                            <p>Asesores</p>
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="{{route('administrador.alumnos', $admin->id)}}">
                            <i class="fas fas fa-user-alt" style='font-size:18px'></i>
                            <p>Alumnos</p>
                        </a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="{{ route('administrador.comentarios', $admin->id)}}">
            ...
            <div class="content" style=" background-image: url({{asset('assets/img/sn23.jpg')}})">
                ...
                <div class="row">
                  ...
                  align-items: center; flex-wrap: wrap;">
                                        <div>
                                            <div>
                                                <h4 class="panel-title">ADMINISTRADOR</h4>
                                            </div>
                                        </div>
                                        <div>
                                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                                <span class="username">{{ strtok($admin->nombre, " ") }}</span>
                                                <b class="caret"></b>
                                            </a>
                                            <ul class="dropdown-menu extended logout">
                                                <li class="eborder-top">
                                                    <a
                                                        href="{{ route('administrador.perfil', Crypt::encrypt($admin->matricula)  )}}">
                                                        Mi Perfil</a>
                                                </li>
                                                <li>
                                                    <a href="{{route('administrador_log')}}"> Cerrar Sesión</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
