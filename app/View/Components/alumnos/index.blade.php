      ...
      <div class="row">
        <fieldset class="col-md-12">
          ...
          <div class="row align-items-center ">
            <div class="col-md-5 ">
              <img src="{{ $alu->foto }}" class="av" width="auto" height="250" alt="{{ $alu->nombre }}">
            </div>
          ...
          <div class="panel-footer center">
            ...
            <a href="{{route('alumnos.edperfil',Crypt::encrypt($alu->id))}}" data-original-title="Editar Datos"
              data-toggle="tooltip" type="button" class="btn btn-primary">Editar datos personales</a>
          </div><br><br>
        </fieldset>
      </div>
    </div>
